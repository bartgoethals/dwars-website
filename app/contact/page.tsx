        ...
        <div className="flex flex-col w-full min-h-full pb-48 relative transition-colors duration-300">
            <div className="w-full max-w-[900px] mx-auto p-6 md:p-12">
                ...
                <div className="mt-12 flex flex-col gap-10">
                    ...
                    <section className="bg-dwars-gray/10 dark:bg-gray-800 p-8 border-2 border-black dark:border-gray-500 transition-colors">
                        <h3 className="font-heading text-4xl mb-4 uppercase tracking-wide text-dwars-pink">Algemene Gegevens</h3>

                        <p className="font-sans text-xl leading-relaxed text-gray-900 dark:text-gray-100 font-bold mb-2 transition-colors">
                        ...
                        <div className="flex flex-col gap-2">
                            <p className="font-sans text-lg text-gray-800 dark:text-gray-300 transition-colors">
                                <strong>Algemene info:</strong> <a href="mailto:contact@dwars.be" className="text-dwars-pink underline hover:text-black dark:hover:text-white transition-colors">contact@dwars.be</a>
                            </p>
                            <p className="font-sans text-lg text-gray-800 dark:text-gray-300 transition-colors">
                                <strong>Adverteren:</strong> <a href="mailto:adverteren@dwars.be" className="text-dwars-pink underline hover:text-black dark:hover:text-white transition-colors">adverteren@dwars.be</a>
                            </p>
                            <p className="font-sans text-lg text-gray-800 dark:text-gray-300 transition-colors">
                                <strong>Meewerken:</strong> <a href="mailto:werving@dwars.be" className="text-dwars-pink underline hover:text-black dark:hover:text-white transition-colors">werving@dwars.be</a>
                            </p>
                        </div>
                    </section>
                    ...
                    <section>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                            <div className="border border-gray-300 dark:border-gray-700 p-6 flex flex-col items-center text-center hover:border-black dark:hover:border-white transition-colors">
