    ...
    return (
        <div className="flex w-full h-full relative transition-colors duration-300">
            ...
            <div className="flex-1 p-12 pr-6 max-w-4xl mx-auto">
                ...
                {/* Meta */}
                <div className="text-sm font-bold tracking-widest uppercase mb-12 border-b-2 border-dashed border-gray-300 dark:border-gray-600 pb-4 transition-colors">
                    12 DECEMBER 2025 — THIJS VAN DAM
                </div>

                {/* Article Body */}
                <div className="prose prose-lg max-w-none text-gray-800 dark:text-gray-300 font-sans leading-loose space-y-6 transition-colors">
            ...
            <aside className="w-[320px] p-8 pl-6 border-l-2 border-dashed border-gray-200 dark:border-gray-700 shrink-0 bg-[#fefefe] dark:bg-[#222222] transition-colors">
                <div className="sticky top-8 space-y-12">
                    ...
                    <div className="bg-[#f8f8f8] dark:bg-gray-800 p-6 shadow-sm relative border border-gray-200 dark:border-gray-700 transition-colors">
                        <div className="absolute -top-3 left-1/2 -translate-x-1/2 w-16 h-6 bg-tape/30 backdrop-blur-sm shadow-sm rotate-2 z-10" />
                        <h3 className="font-heading text-2xl mb-6 uppercase dark:text-white transition-colors">Gerelateerde artikels</h3>
                        <div className="flex flex-col gap-4">
                            {[1, 2, 3].map((i) => (
                                <Link href="#" key={i} className="flex gap-4 group cursor-pointer border-b border-gray-200 dark:border-gray-700 pb-4 last:border-0 last:pb-0 transition-colors">
                                    ...
                                    <div className="flex-1">
                                        <h4 className="font-bold text-sm leading-tight dark:text-gray-200 group-hover:text-dwars-pink dark:group-hover:text-dwars-pink transition-colors">Lorem ipsum dolor sit amet {i}</h4>
                                    </div>
                                </Link>
                            ))}
                        </div>
                    ...
                    <div className="bg-[#f0f0f0] dark:bg-gray-800 aspect-[4/5] w-full p-6 flex flex-col relative border border-gray-300 dark:border-gray-700 pointer-events-none overflow-hidden transition-colors">
                        ...
                        <h4 className="font-heading text-3xl leading-tight mb-4 relative z-10 dark:text-white transition-colors">Betrouwbare journalistiek is nooit gratis.</h4>
