        ...
        <div className="flex flex-col w-full min-h-full pb-48 relative transition-colors duration-300">
            <div className="w-full max-w-[900px] mx-auto p-6 md:p-12">
                ...
                <div className="mt-12 flex flex-col gap-10">
                    <section>
                        <h3 className="font-heading text-3xl md:text-4xl mb-4 uppercase tracking-wide dark:text-white transition-colors">Kritische Meerwaarde</h3>
                    ...
                    <section>
                        <h3 className="font-heading text-3xl md:text-4xl mb-4 uppercase tracking-wide dark:text-white transition-colors">Taak</h3>
                        <p className="font-sans text-lg leading-relaxed text-gray-200 md:text-gray-800 dark:text-gray-300 mb-4 transition-colors">
                    ...
                    <section>
                        <h3 className="font-heading text-3xl md:text-4xl mb-4 uppercase tracking-wide dark:text-white transition-colors">Redactie</h3>
                        <p className="font-sans text-lg leading-relaxed text-gray-200 md:text-gray-800 dark:text-gray-300 mb-4 transition-colors">
                    ...
                    <section>
                        <h3 className="font-heading text-3xl md:text-4xl mb-4 uppercase tracking-wide dark:text-white transition-colors">Verantwoordelijkheid</h3>
                        <p className="font-sans text-lg leading-relaxed text-gray-200 md:text-gray-800 dark:text-gray-300 mb-4 transition-colors">
                        ...
                        <p className="font-sans text-sm font-bold text-gray-400 md:text-gray-500 dark:text-gray-400 italic mt-8 transition-colors">
